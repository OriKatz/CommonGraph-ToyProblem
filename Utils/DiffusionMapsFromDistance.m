...
function [MapEmbd, UWighted, d_t, singvals]=DiffusionMapsFromDistance_correct(d,t,numNeighbors)
%
...
%               "-1" indicates taking the median value of the d(:) as the scaling constant \epsilon.
...
%
    ...
    %
    [A,eps]=AffinityFromDistance( d, numNeighbors);%figure(); imagesc(A)
    %
